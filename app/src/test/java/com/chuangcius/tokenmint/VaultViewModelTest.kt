...
class VaultViewModelTest {
    ...
    @Test
    fun `initial load sets Success state with empty tokens`() =
        runTest {
            advanceUntilIdle()
    ...
    @Test
    fun `addToken adds to success state`() =
        runTest {
    ...
    @Test
    fun `deleteToken removes from state`() =
        runTest {
            advanceUntilIdle()
    ...
    @Test
    fun `togglePin toggles isPinned`() =
        runTest {
            advanceUntilIdle()
    ...
    @Test
    fun `importVault adds new tokens`() =
        runTest {
            advanceUntilIdle()
